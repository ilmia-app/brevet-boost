...
- Le corrigé peut utiliser markdown : ### titres, **gras**, listes -, $...$ pour les formules.`;
    ...
    const blocInstructions: Record<string, string> = {
      ...
      "TEC-01": "ATTENTION TECHNO SCRATCH : Le programme que tu inventes dans l'ÉNONCÉ doit être LOGIQUEMENT CORRECT et COHÉRENT avec ce qu'il est censé faire. RÈGLE ABSOLUE : pour calculer une moyenne de N notes, le programme DOIT diviser la somme par N (3 notes → /3, 4 notes → /4, etc.). Ne JAMAIS écrire 'somme / 2' pour 3 notes ou plus — c'est une erreur grave. Avant de rédiger, simule mentalement le programme PAS À PAS avec des valeurs concrètes et vérifie que le résultat correspond à ce que l'énoncé annonce. Vérifie chaque boucle, chaque condition, chaque calcul de variable. Si l'énoncé dit 'calcule la moyenne de 3 notes', le programme doit diviser par 3, point. Ne jamais inventer le comportement d'un bloc Scratch.",
